...
def atualizar_grafico(operador, equipamento, data_str):
    ...
    stats_html = html.Div([
        ...
        html.Span("Parada Gerenciável: ", style={"color":"#FF9393", "font-weight":"bold"}),
        html.Span(f"{parada_gerenciavel:.2f}h", style={"margin-right":"18px", "color":"#FA9770"}),
        html.Span("Parada Mecânica: ", style={"color":"#A52657", "font-weight":"bold"}),
        html.Span(f"{parada_mecanica:.2f}h", style={"margin-right":"18px", "color":"#A52657"}),
        html.Span("Parada Improdutiva: ", style={"color":"#FF0000", "font-weight":"bold"}),
        ...
        html.Span("Deslocamento: ", style={"color":"#4E4C27", "font-weight":"bold"}),
        html.Span(f"{deslocamento:.2f}h", style={"margin-right":"18px", "color":"#4E4C27"}),
